...
<body>
    <div class="ticket">
        <p class="centered">
            <h1 class="centered">Richie Leosala Store
                <br />and
                <br />
                General Merchandise</h1>
        </p>
        <p class="centered">Purok 3 Picasales St. <br />Mangagoy Bislig City</p>
        </p>
        <?php
        echo "
                <b>Order No: <br />$id</b>
        ...
        <p class="centered">
            <?php
                echo "<img alt='testing' src='barcode.php?codetype=Code128&size=50&text=" . $id . "&print=true' style='max-width: 150px;'/>";
            ?>
        </p>
